...
exports.start = function(strat_file, quotfile, onSuccess, onError){
  ...
  OpenJSONquotation.start(Fs,quotfile,function(instru_list_check, instru_quotation){
    ...
    OpenJSONsettingsFile.start(Fs,__dirname+"/../lib/global/indicators/indicators_global_config.json",function(idctr_global_settings){
      OpenJSONsettingsFile.start(Fs,__dirname+"/../lib/global/pattern/pattern.json",function(pattern_global_settings){
